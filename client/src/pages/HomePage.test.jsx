...
describe('HomePage Component', () => {
  test('renders landing page for unauthenticated users', () => {
    ...
    expect(screen.getByText('Your Personal AI Mood Companion')).toBeInTheDocument();
    expect(screen.getByText('Track your emotions, journal your thoughts, and find support in our community')).toBeInTheDocument();
    ...
    expect(screen.getByText('Features to Support Your Emotional Well-being')).toBeInTheDocument();
  ...
  test('renders dashboard for authenticated users', async () => {
    ...
    await waitFor(() => {
      expect(screen.queryByText('Loading your personal dashboard...')).not.toBeInTheDocument();
    });
    ...
    expect(screen.getByText('Feeling anxious about presentation')).toBeInTheDocument();
  });
  ...
  test('displays daily affirmation', () => {
    ...
    const affirmationElement = screen.getByText("Today's Affirmation").nextElementSibling;
